...
public class Dispenser {
	...
	public Dispenser () {
		...
		productsForSale = new Product[4];
		
		productsForSale[0] = new Drink ("Coke", 1.75, 16);
		productsForSale[1] = new Candy ("Snickers", 1.00, 7);
		productsForSale[2] = new Chips ("Cheetos", 1.75, 15);
		productsForSale[3] = new Gum ("Strident", "Spearmint", .75, 1);
	}
